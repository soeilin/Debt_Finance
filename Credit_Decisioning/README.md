## Project Overview
All datasets used in these projects are synthetic and created solely for learning and demonstration purposes.

### 1. Credit Strategy Lite (Rule-based Decisioning Prototype)
A simplified credit-strategy framework illustrating how lending rules, risk flags, and approval/decline logic interact within an automated decision engine.  
Includes cut-off rules, affordability checks, risk triggers, and decision outcomes.
The structure mirrors real-world rule deployment pipelines used in automated lending platforms (e.g., segmentation → affordability → risk triggers → decision outcome).

### 2. Portfolio KPI Monitoring (MoM / Risk Trends)
...
Highlights how behavioural clusters translate into actionable credit-strategy rules (e.g., differentiated cut-offs, tailored treatment paths).
